...
CFLAGS = -std=gnu11 -Wall -Wno-missing-braces -Wunused-result -D_DEFAULT_SOURCE
...
ifeq ($(BUILD_MODE),DEBUG)
    ...
    ifeq ($(PLATFORM),PLATFORM_WEB)
        ifeq ($(BUILD_WEB_ASYNCIFY),TRUE)
            CFLAGS += -O3 -s ASYNCIFY
        else
            CFLAGS += -Os -s ASYNCIFY
        endif
    else
        CFLAGS += -s -O2
    endif
...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -I$(RAYLIB_PATH)/src/extras -Ilua/src
